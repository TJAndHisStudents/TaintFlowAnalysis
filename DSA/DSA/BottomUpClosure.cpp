...
void BUDataStructures::calculateGraph(DSGraph* Graph) {
  ...
  for(DSGraph::FunctionListTy::iterator I = TempFCs.begin(), E = TempFCs.end();
    ...
    {
     //   errs()<<"\nCall Site:  ";
       // CS.getCallSite().getInstruction()->dump();
      //  errs()<< " Number of Callees :"<<CalledFuncs.size();
        indirectCAlls++;
    }
    ...
    if (CalledFuncs.empty()) {
      ...
      if (CS.isIndirectCall())
      {
       ...
       // errs()<<"\n Unresolved Call :";
        ...
        //CS.getCallSite().getCalledValue()->dump();
        //CS.getCallSite().getInstruction()->dump();
      }
 ...
 // errs()<<"Numebr of indirect calls: "<< indirectCAlls;
 ...
 std::string fileName = "DSGraphInfo.txt";
  ...
  std::string funcNames = Graph->getFunctionNames();


  Graph->writeGraphToFile(File, "../../TestFiles/"+funcNames);
  ----------------------------------------------*/
