...
typedef enum {
    gtFunctionData = 0, gtWholeData = 1, gtFunctionControl = 2,gtWholeControl = 3
} graphType;


typedef enum {
    ntActualIn = 0, ntActualOut = 1, ntFormalIn = 2, ntFormalOut = 3, ntField = 4, ntEntry = 5, ntGlobal = 6, ntReturn = 7, ntInst = 8
} nodeType;
...
private:
        ...
        int ID;  // incremented in constructor.

//ToDo NT: need to include the object tree eventually...
...
public:
      ...
      //  std::string Name;
        ...
        void initialize(Value* v, nodeType ntype);
...
public:
  //  Function * F;
     ...
     //make the above obsolete.
     GraphNode * entryNode;
     map<Value*,GraphNode*>  FormalInMap;
     map<Value*,GraphNode*>  FormalOutMap;
     map<Value*,GraphNode*>  ActualInMap;
     map<Value*,GraphNode*>  ActualOutMap;
     map<Value*, GraphNode*> RetValMap;
    FuncParamInfo();
};
...
//        llvm::DenseMap<Value*, GraphNode*> memNodes;
        llvm::DenseMap<Value*, GraphNode*> memValNodes;

        //llvm::DenseMap<Value*,GraphNode*> instMap;
...
public:
	...
	typedef std::set<GraphNode*>::iterator iterator;
      ...
      //  map<Function*,FuncParamInfo*>   funcParMapLocal;
        ...
        map<Instruction*, GraphNode*> instMap;
       // map<Value*,GraphNode*> ParaminMap;
       ...
       /* Graph(AliasSets *AS) :
        ...
        std::set<GraphNode*> getDataDepValues(
                    std::set<llvm::Value*> sources, bool forward=true);
	    int getTaintedEdges ();
        ...
        GraphNode* addParamNode(Value *v, Function * func, nodeType nType) ;  //Adds the parameter node for the function.
        GraphNode* addNode(Instruction* inst, nodeType nType);
        GraphNode* addEntryNode(Function *F);
       ...
       // void addControlDependencies(Function* F);
        ...
        //void addDependence(Value *v, int Instcounter, Function* Func, )
        ...
        GraphNode* findInstNode(Value *op);
