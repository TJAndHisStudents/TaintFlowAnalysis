...
public:
        ...
        map<Function*, Graph*> FuncGraphMap;
       ...
       // void deleteCallNodes(Function* F);
        ...
        void TopDownProcessing(Function * F);
        ...
        void addNodes(Function* F, Graph * F_Graph);

        void addDependencies(Value *v, Graph *F_Graph,Function *F);
        void addControlDependencies(Function* F,Graph * F_Graph);

        void addControlDep(GraphNode* from,BasicBlock *to, Graph * F_Graph, edgeType eType);
        void addControlDep(BasicBlock* from,BasicBlock *to, Graph * F_Graph, edgeType eType);


        bool isCallProcessed(CallInst* CI, Function* calledFunc);
        void ProcessCSinFunc(Function * F, bool callString, Graph * modGraph);
        void ConnectCallerCallee(CallInst* CI, Function* calledFunc, Graph * modGraph);
